            ...
            <header className="container m-auto w-full flex justify-between items-center align-center h-[67px] bg-white">
                ...
                <div className="flex items-center gap-4">
                    ...
                    {showLoginButton && (
                        <Link
                            to="/login"
                            className="px-6 py-2 bg-blue-500 text-white rounded-lg hover:bg-blue-600 transition-all duration-300 transform hover:scale-105 focus:outline-none focus:ring-2 focus:ring-blue-500"
                        >
                            Me connecter
                        </Link>
                    )}
